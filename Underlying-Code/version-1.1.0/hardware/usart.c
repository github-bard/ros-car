...
{
	if(USART_GetITStatus(USART3, USART_IT_RXNE) != RESET) //是否接受到数据
    {
		//printf("yes1\r\n");
		serial_rec =USART_ReceiveData(USART3);//(USART3->DR);	//读取接收到的数据
			//printf("serial_rec:%c\r\n",serial_rec);			
