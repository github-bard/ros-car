...
#define ENCODER2_PPR           (u16)(90)  // 电机2码盘线数
#define ENCODER1_PPR           (u16)(90)  // 电机1码盘线数
...
void Gain1(void);//设置电机B PID调节 
void Gain2(void);//设置电机A PID调节 
	
int Read_Encoder(u8 TIMX);
void Ranging(int M1_cnt,int M2_cnt);//单位测距函数	
